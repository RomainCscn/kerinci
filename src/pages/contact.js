          ...
          <div className="columns is-variable is-8">
            <div className="column">
              <div className={style.iconContainer}>
                ...
                <h2 className="is-title is-size-3">Contact information</h2>
              </div>
              <div>
                ...
                <div className="box content">
                  <h3 className="is-title is-size-5">Homestay</h3>
                ...
                <div className="box content">
                  <h3 className="is-title is-size-5">Eco Tours</h3>
                ...
                <div className="content">
                  <h3 className="is-title is-size-5">Contact form</h3>
            ...
            <div className="column">
              <div className={style.iconContainer}>
                ...
                <h2 className="is-title is-size-3">How to get here?</h2>
              </div>
              ...
              <div>
                <div className="box content" style={{marginTop: '24px'}}>
