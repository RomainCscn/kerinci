            ...
            <div className="column">
              ...
              <div>
                <div className="box content" style={{marginTop: '24px'}}>
                  <div className="title is-size-5">Option 1: From Padang, West Sumatra</div>
                ...
                <div className="box content">
                  <div className="title is-size-5">Option 2: Fly from Jambi airport (DJB) to Kerinci airport (KRC)</div>
