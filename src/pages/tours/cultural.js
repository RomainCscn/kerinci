    ...
    return (
      ...
      <section>
        <div className={style.iconContainer}>
          ...
          <h2 className="title is-size-3" >Cinnamon harvest</h2>
        </div>
      ...
      <section style={{backgroundColor: '#F4F4F4'}}>
        <div className={style.iconContainer}>
          ...
          <h2 className="title is-size-3" >Tea plantation</h2>
        </div>
        <div className="container content" style={{maxWidth: '800px'}}> 
      ...
      <section>
        <div className={style.iconContainer}>
          ...
          <h2 className="title is-size-3" >Traditional dance</h2>
        </div>
        <div className="container content" style={{maxWidth: '800px'}}> 
      ...
      <section style={{backgroundColor: '#F4F4F4'}}>
        <div className={style.iconContainer}>
          ...
          <h2 className="title is-size-3" >Traditional market</h2>
        </div>
        <div className="container content" style={{maxWidth: '800px'}}> 
