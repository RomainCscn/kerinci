    ...
    return (
      ...
      <section>
        <div className={style.iconContainer}>
          ...
          <h2 className="is-title is-size-3" style={{ borderBottom: '2px solid grey'}}>Traditional dance</h2>
        </div>
        <div className="container content" style={{maxWidth: '800px'}}> 
      ...
      <section style={{backgroundColor: '#F4F4F4'}}>
        <div className={style.iconContainer}>
          ...
          <h2 className="is-title is-size-3" style={{ borderBottom: '2px solid grey'}}>Traditional market</h2>
        </div>
        <div className="container content" style={{maxWidth: '800px'}}> 
